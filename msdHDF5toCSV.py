...
def main():
    ...
    if prompt == True:
        while prompt:
            ...
            csvAttributeString = raw_input("\n\nIn what order would you like the colums of the CSV file?\n" +
                ...
                " SongID, TimeSignature, TimeSignatureConfidence, Title, Year, Energy, and Loudness.\n\n" +
    ...
    #the user, 
        ...
        csvRowString = ("SongID,AlbumID,AlbumName,ArtistID,ArtistLatitude,ArtistLocation,"+
            ...
            "Title,Year,Energy,Loudness")
#        csvRowString = ("SongID,Title,AlbumName,"+
#            "ArtistName,KeySignature,"+
#            "Tempo,TimeSignature,"+
#            "Energy,Loudness")
        #################################################
    ...
    basedir = "/Users/rahuldhakecha/coursesfall2016/introtoML/project/codes/MillionSongSubset" # "." As the default means the current directory
